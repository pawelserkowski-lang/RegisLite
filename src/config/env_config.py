...
class Config:
    ...
    def _print_summary(self):
        ...
        logger.info(f"   Anthropic Key: {'✓ SET' if self.ANTHROPIC_API_KEY else '○ Optional'}")
        logger.info(f"   GitHub Token: {'✓ SET' if self.GITHUB_TOKEN else '○ Optional'}")
...
def main():
    ...
    parser.add_argument("--list", type=str, nargs="?", const="", help="Listuj ENV vars (opcjonalny prefix)")
    parser.add_argument("--set", type=str, nargs=2, metavar=("KEY", "VALUE"), help="Ustaw Windows ENV var")
